...
62 finding(s): 1 × A · 12 × B · 40 × C · 9 × D
...
| A10-037 | B | CONFIRMED | `/` | desktop-1440 | The site states three different ISO 9001 revisions — :2008, :2000 and unversioned | _harness/out/audit10/issues/A10-037__desktop-1440__home-iso-9001-2008.png |
| A10-045 | B | CONFIRMED | `/` | all | No --brand-accent-rgb variable exists, so every translucent accent tint is a literal and survives a repalette | _harness/out/audit10/issues/A10-045__desktop-1440__home-accent-tints-after.png |
| A10-046 | B | CONFIRMED | `/products?productId=IP38FE` | desktop-1440 | Two brand gradients and two navy surfaces are hardcoded literals: after a repalette they read navy-to-new-colour | _harness/out/audit10/issues/A10-046__desktop-1440__product-header-gradient-after.png |
| A10-056 | B | CONFIRMED | `/products` | all | Browser Back does not restore scroll position on /products — the buyer is returned to the top of the 42-card catalog | _harness/out/audit10/issues/A10-056__desktop-1440__catalog-after-back-scroll-lost.png |
...
| A10-038 | C | CONFIRMED | `/dashboard` | desktop-1440 | Four components cut product copy at a fixed character count, landing mid-word 49 times on /dashboard alone | _harness/out/audit10/issues/A10-038__desktop-1440__dashboard-midword-slices.png |
| A10-039 | C | CONFIRMED | `/admin/content.php` | desktop-1440 | Page Content: 96 accessible names announce a literal "&amp;" instead of "and" | _harness/out/audit10/issues/A10-039__desktop-1440__content-row-accessible-names.png |
| A10-040 | C | CONFIRMED | `/admin/settings.php` | desktop-1440 | Business Details "Live preview" shows a copyright line the site has never rendered | _harness/out/audit10/issues/A10-040__desktop-1440__settings-live-preview.png |
| A10-041 | C | CONFIRMED | `/admin/settings.php` | desktop-1440 | Two Business Details field hints explain a field using developer vocabulary and nothing else | _harness/out/audit10/issues/A10-041__desktop-1440__settings-hints.png |
| A10-042 | C | CONFIRMED | `/` | desktop-1440 | The homepage makes two different shipping promises, two sections apart | _harness/out/audit10/issues/A10-042__desktop-1440__home-hero-stats.png |
| A10-047 | C | CONFIRMED | `/products` | all | The border role carries five near-identical greys, two of them 1.41 apart in sRGB | _harness/out/audit10/issues/A10-047__desktop-1440__spec-table-border-grey.png |
| A10-048 | C | CONFIRMED | `/industries` | all | One card class paints three different elevations depending on which page it is on | _harness/out/audit10/issues/A10-048__desktop-1440__card-shadow-industries.png |
| A10-049 | C | CONFIRMED | `/admin/content.php` | all | Admin buttons never get font-family:inherit, so 776 of them render in the UA font at line-height 1 | _harness/out/audit10/issues/A10-049__desktop-1440__admin-rbtn-arial.png |
| A10-050 | C | CONFIRMED | `/admin/settings.php` | all | The admin's low-emphasis greys render at 1.82-2.54:1 — the field help under every setting is the least readable text there | _harness/out/audit10/issues/A10-050__desktop-1440__admin-hint-text-2.54to1.png |
| A10-051 | C | CONFIRMED | `/faq` | all | /faq paints its h3 two pixels larger than every h2 on the page, inverting the heading scale | _harness/out/audit10/issues/A10-051__desktop-1440__faq-h3-larger-than-h2.png |
| A10-055 | C | CONFIRMED | `/` | desktop-1440 | Escape does not close either mega-menu once focus or the pointer has moved into the panel | _harness/out/audit10/issues/A10-055__desktop-1440__mega-menu-still-open-after-escape.png |
| A10-057 | C | CONFIRMED | `/products?productId=CC` | all | Two one-shot motions ignore prefers-reduced-motion: the sticky RFQ bar's spring slide and the FAQ panel's collapse | _harness/out/audit10/issues/A10-057__desktop-1440__sticky-rfq-mid-slide-under-reduce.png |
| A10-058 | C | CONFIRMED | `/products?productId=IP33PO` | mobile-390 | Opening and closing the mobile menu leaves the page 276px below where the visitor was | _harness/out/audit10/issues/A10-058__mobile-390__after-closing-the-menu-scrollY-876.png |
| A10-059 | C | CONFIRMED | `/products?productId=CC` | tablet-834 | At 834 the product title lands behind the sticky navbar after navigating from the catalog sidebar | _harness/out/audit10/issues/A10-059__tablet-834__product-h1-under-the-sticky-navbar.png |
| A10-060 | C | CONFIRMED | `/about` | all | Four components declare Tailwind hover: utilities that their own inline style overrides, so the hover never paints | _harness/out/audit10/issues/A10-060__desktop-1440__about-timeline-card-hovered-identical.png |
| A10-061 | C | CONFIRMED | `/dashboard` | all | Whole control families have no hover feedback while comparable families on the same pages do | _harness/out/audit10/issues/A10-061__desktop-1440__sort-header-hovered-identical.png |
...
| A10-043 | D | CONFIRMED | `/contact` | desktop-1440 | Batched public-site character and terminology drift: apostrophes, British spelling, term casing | _harness/out/audit10/issues/A10-043__desktop-1440__contact-enquiry.png |
| A10-044 | D | CONFIRMED | `/admin/` | desktop-1440 | Batched admin copy nits not covered by A10-036: tab title, ellipsis style, a JSON-only error path | — |
| A10-052 | D | CONFIRMED | `/admin/index.php` | all | Batched: admin text that misses AA by 0.1-0.35, on surfaces A10-030 does not name | _harness/out/audit10/issues/A10-052__desktop-1440__admin-delete-button-4.28to1.png |
| A10-053 | D | CONFIRMED | `/datasheets` | all | Batched design-token nits: off-scale type sizes, a 1px radius split, and two monospace stacks for one role | — |
| A10-054 | D | CONFIRMED | `/` | all | Batched: the three brand-bearing image assets carry blues that are near but not equal to the palette, and none can repalette | _harness/out/audit10/issues/A10-054__desktop-1440__logo-blue-vs-brand-blue.png |
| A10-062 | D | CONFIRMED | `/` | all | Focus indication is split three ways — a designed accent ring on 3 classes, a custom border/shadow on admin fields, the browser default everywhere else | _harness/out/audit10/issues/A10-062__desktop-1440__designed-ring-on-sort-header.png |
...
## A10-037 · [B] The site states three different ISO 9001 revisions — :2008, :2000 and unversioned

**URL** `/` · **viewport** desktop-1440 · **confidence** CONFIRMED · **pass** pass-4 · **date** 2026-08-10
...
Screenshot: `_harness/out/audit10/issues/A10-037__desktop-1440__home-iso-9001-2008.png` (gitignored; re-capture via reproduce steps if absent)
Probe: `_harness/audit10-facts.js (fact census) + _harness/audit10-copyverify.js (V2, browser confirmation)`
...
Screenshot: `_harness/out/audit10/issues/A10-045__desktop-1440__home-accent-tints-after.png` (gitignored; re-capture via reproduce steps if absent)
Probe: `_harness/audit10-repalette.js`
...
**Severity rationale.** Rick is invited to re-skin the whole site from Business Details -> Branding, and 4.23 built the machinery that makes that safe. The primary colour got an -rgb companion variable (--brand-primary-rgb, 53 call sites) precisely so translucent tints follow it; the accent never did. Pick any non-cyan brand and the site keeps a cyan hairline under the header on every page, cyan-bordered certification badges on the homepage and all five industry cards, and a cyan-tinted chip behind all 42 rows of the product index. It is not subtle and there is no workaround in the admin.

## A10-046 · [B] Two brand gradients and two navy surfaces are hardcoded literals: after a repalette they read navy-to-new-colour

**URL** `/products?productId=IP38FE` · **viewport** desktop-1440 · **confidence** CONFIRMED · **pass** pass-5 · **date** 2026-08-10
...
Screenshot: `_harness/out/audit10/issues/A10-046__desktop-1440__product-header-gradient-after.png` (gitignored; re-capture via reproduce steps if absent)
Probe: `_harness/audit10-repalette.js`
...
**Severity rationale.** This is the louder half of the repalette defect. The product-detail header is a two-stop gradient whose second stop is var(--brand-primary) and whose first stop is the literal #0a2a52 — on all 42 product pages. Change the brand and the single most prominent block on the page a buyer lands on becomes a gradient from the OLD navy to the NEW colour: not merely unthemed, actively clashing. The same shape repeats on the five /industries card headers, the desktop mega-dropdown panel and the mobile navigation drawer.

## A10-056 · [B] Browser Back does not restore scroll position on /products — the buyer is returned to the top of the 42-card catalog

**URL** `/products` · **viewport** all · **confidence** CONFIRMED · **pass** pass-6 · **date** 2026-08-10

**What it does to a real person.** A buyer scrolls a third of the way down the catalog, opens a product, then presses Back to keep looking. The catalog reopens at or near the top and they have to scroll and re-find where they were. Comparing four or five parts means doing that four or five times.

**Evidence.** history.scrollRestoration is 'auto'. Scroll /products to y=1200, click the first visible product card, wait 1.5s, press Back, wait 2.5s: desktop-1440 y=44, tablet-834 y=0, mobile-390 y=61 — never near 1200. Measured twice per viewport, six runs, identical every time. Forward is unaffected and restores the product page exactly (44 / 1690 / 2067 matching the outbound value), so the history mechanism works and only the Back leg loses the offset.
Screenshot: `_harness/out/audit10/issues/A10-056__desktop-1440__catalog-after-back-scroll-lost.png` (gitignored; re-capture via reproduce steps if absent)
Probe: `_harness/audit10-p6verify2.js`

**Reproduce.**
1. Open http://127.0.0.1:8123/products at 1440x900
2. Scroll to y=1200 (about a third of the way down the 42-card grid)
3. Click any product card
4. Press the browser Back button and wait for the catalog to re-render
5. Read window.scrollY — it is 44, not 1200

**Severity rationale.** This is the site's main browsing loop: a buyer comparing parts opens a card, reads it, presses Back, and has to find their place among 42 cards again — on every single comparison. It is a real defect a visitor will hit and notice in normal use, with a workaround (scroll down again), which is exactly B. Forward restores correctly, so the loss is one-directional and specific.

**Dedupe.** Not A10-005 (pass-1), which is about the product-page catalog RAIL never scrolling to the selected product inside its own scroller. This is the browser history's scroll restoration on the /products landing grid.
...
## A10-038 · [C] Four components cut product copy at a fixed character count, landing mid-word 49 times on /dashboard alone

**URL** `/dashboard` · **viewport** desktop-1440 · **confidence** CONFIRMED · **pass** pass-4 · **date** 2026-08-10
...
Screenshot: `_harness/out/audit10/issues/A10-038__desktop-1440__dashboard-midword-slices.png` (gitignored; re-capture via reproduce steps if absent)
Probe: `_harness/audit10-trunc.js`
...
Screenshot: `_harness/out/audit10/issues/A10-039__desktop-1440__content-row-accessible-names.png` (gitignored; re-capture via reproduce steps if absent)
Probe: `_harness/audit10-copyscan.js (section a) + _harness/audit10-copyverify.js (V1)`
...
**Dedupe.** Not A10-036: that batches button-label casing, catalogue/catalog, British spellings and one straight-vs-curly hint on the same page. This is a double-escape defect in the accessible-name layer, which A10-036 does not mention and which no visible string reveals.

## A10-040 · [C] Business Details "Live preview" shows a copyright line the site has never rendered

**URL** `/admin/settings.php` · **viewport** desktop-1440 · **confidence** CONFIRMED · **pass** pass-4 · **date** 2026-08-10
...
Screenshot: `_harness/out/audit10/issues/A10-040__desktop-1440__settings-live-preview.png` (gitignored; re-capture via reproduce steps if absent)
Probe: `_harness/audit10-copyverify.js (V13, V13b)`
...
**Dedupe.** Distinct from A10-033 (help page miscounting nav links and action buttons): this is the settings preview, and the disagreement is with the rendered footer rather than with the admin chrome.

## A10-041 · [C] Two Business Details field hints explain a field using developer vocabulary and nothing else
...
Screenshot: `_harness/out/audit10/issues/A10-041__desktop-1440__settings-hints.png` (gitignored; re-capture via reproduce steps if absent)
Probe: `_harness/audit10-copyverify.js (V14)`
...
**Dedupe.** Pass-3 recorded admin-copy defects on help.php (A10-028/029/031/033/034) and on audit-log.php (A10-025); none is on settings.php and none is about undefined vocabulary. The "755 over FTP" line on /admin/index.php is deliberately excluded — it is prefixed "Server setup problem — please send this to your developer.", which names the right reader.

## A10-042 · [C] The homepage makes two different shipping promises, two sections apart
...
Screenshot: `_harness/out/audit10/issues/A10-042__desktop-1440__home-hero-stats.png` (gitignored; re-capture via reproduce steps if absent)
Probe: `_harness/audit10-copyshots.js + _harness/audit10-copyverify.js (V7)`
...
**Dedupe.** Pass-1 recorded homepage layout findings (A10-007 heading alignment) but nothing about the duplicated stat strips or their copy.

## A10-047 · [C] The border role carries five near-identical greys, two of them 1.41 apart in sRGB

**URL** `/products` · **viewport** all · **confidence** CONFIRMED · **pass** pass-5 · **date** 2026-08-10
...
Screenshot: `_harness/out/audit10/issues/A10-047__desktop-1440__spec-table-border-grey.png` (gitignored; re-capture via reproduce steps if absent)
Probe: `_harness/audit10-colorclust.js`
...
## A10-048 · [C] One card class paints three different elevations depending on which page it is on

**URL** `/industries` · **viewport** all · **confidence** CONFIRMED · **pass** pass-5 · **date** 2026-08-10
...
Screenshot: `_harness/out/audit10/issues/A10-048__desktop-1440__card-shadow-industries.png` (gitignored; re-capture via reproduce steps if absent)
Probe: `_harness/audit10-tokens.js`
...
## A10-049 · [C] Admin buttons never get font-family:inherit, so 776 of them render in the UA font at line-height 1

**URL** `/admin/content.php` · **viewport** all · **confidence** CONFIRMED · **pass** pass-5 · **date** 2026-08-10
...
Screenshot: `_harness/out/audit10/issues/A10-049__desktop-1440__admin-rbtn-arial.png` (gitignored; re-capture via reproduce steps if absent)
Probe: `_harness/audit10-tokens.js`
...
## A10-050 · [C] The admin's low-emphasis greys render at 1.82-2.54:1 — the field help under every setting is the least readable text there

**URL** `/admin/settings.php` · **viewport** all · **confidence** CONFIRMED · **pass** pass-5 · **date** 2026-08-10
...
Screenshot: `_harness/out/audit10/issues/A10-050__desktop-1440__admin-hint-text-2.54to1.png` (gitignored; re-capture via reproduce steps if absent)
Probe: `_harness/audit10-admincontrast.js`
...
**Dedupe.** Not A10-030, which measured the red .error-list treatment at 4.41:1 and names only the error blocks on settings.php / content.php / upload-image.php. This is a different token (#9ca3af / #aeb8c4 grey, not #dc2626 red), a different set of elements (field help, table metadata, the help-page table of contents, the add.php preview placeholders) and roughly half the ratio. brandtext and the plan5c suites never load /admin, so nothing measured any of this before.

## A10-051 · [C] /faq paints its h3 two pixels larger than every h2 on the page, inverting the heading scale

**URL** `/faq` · **viewport** all · **confidence** CONFIRMED · **pass** pass-5 · **date** 2026-08-10
...
Screenshot: `_harness/out/audit10/issues/A10-051__desktop-1440__faq-h3-larger-than-h2.png` (gitignored; re-capture via reproduce steps if absent)
Probe: `_harness/audit10-headings.js`
...
## A10-055 · [C] Escape does not close either mega-menu once focus or the pointer has moved into the panel

**URL** `/` · **viewport** desktop-1440 · **confidence** CONFIRMED · **pass** pass-6 · **date** 2026-08-10
...
Screenshot: `_harness/out/audit10/issues/A10-055__desktop-1440__mega-menu-still-open-after-escape.png` (gitignored; re-capture via reproduce steps if absent)
Probe: `_harness/audit10-p6verify.js`
...
**Severity rationale.** A buyer navigating by keyboard opens Products, tabs into it, presses the universal dismiss key and nothing happens; the panel keeps covering the hero until they tab through all 13 links or reach for the mouse. Held at C rather than B because nothing is unreachable — Tab still exits the panel and a click elsewhere closes it — and the lower level is taken per severity.json when torn.

## A10-057 · [C] Two one-shot motions ignore prefers-reduced-motion: the sticky RFQ bar's spring slide and the FAQ panel's collapse

**URL** `/products?productId=CC` · **viewport** all · **confidence** CONFIRMED · **pass** pass-6 · **date** 2026-08-10
...
Screenshot: `_harness/out/audit10/issues/A10-057__desktop-1440__sticky-rfq-mid-slide-under-reduce.png` (gitignored; re-capture via reproduce steps if absent)
Probe: `_harness/audit10-p6verify3.js`
...
**Dedupe.** Not the plan8-motion set. That suite's subject is infinite animations (the trust marquee, the skeleton shimmer, the submit spinner) and it is still 8/8 green this session. These two are one-shot transitions it does not look at.

## A10-058 · [C] Opening and closing the mobile menu leaves the page 276px below where the visitor was

**URL** `/products?productId=IP33PO` · **viewport** mobile-390 · **confidence** CONFIRMED · **pass** pass-6 · **date** 2026-08-10
...
Screenshot: `_harness/out/audit10/issues/A10-058__mobile-390__after-closing-the-menu-scrollY-876.png` (gitignored; re-capture via reproduce steps if absent)
Probe: `_harness/audit10-p6verify2.js`
...
**Dedupe.** Does not contradict plan8-mobile's restore assertion, which is about the lock returning the offset it captured and is correct. The displacement happens upstream of the capture. plan8-mobile.js:124-131 attributes the same 600 -> 876 shift to Playwright scrolling the burger into view before clicking it; this measurement reproduces it with no click and no auto-scroll, so a real visitor sees it too.

## A10-059 · [C] At 834 the product title lands behind the sticky navbar after navigating from the catalog sidebar

**URL** `/products?productId=CC` · **viewport** tablet-834 · **confidence** CONFIRMED · **pass** pass-6 · **date** 2026-08-10
...
Screenshot: `_harness/out/audit10/issues/A10-059__tablet-834__product-h1-under-the-sticky-navbar.png` (gitignored; re-capture via reproduce steps if absent)
Probe: `_harness/audit10-p6verify2.js`
...
**Dedupe.** Not A10-005 (pass-1), which is the sidebar rail failing to scroll ITSELF to the selected product. This is where the MAIN column lands afterwards, and it is specific to the 834 band — desktop is clear and 390 is nearly clear.

## A10-060 · [C] Four components declare Tailwind hover: utilities that their own inline style overrides, so the hover never paints

**URL** `/about` · **viewport** all · **confidence** CONFIRMED · **pass** pass-6 · **date** 2026-08-10
...
Screenshot: `_harness/out/audit10/issues/A10-060__desktop-1440__about-timeline-card-hovered-identical.png` (gitignored; re-capture via reproduce steps if absent)
Probe: `_harness/audit10-p6comp.js`
...
## A10-061 · [C] Whole control families have no hover feedback while comparable families on the same pages do

**URL** `/dashboard` · **viewport** all · **confidence** CONFIRMED · **pass** pass-6 · **date** 2026-08-10
...
Screenshot: `_harness/out/audit10/issues/A10-061__desktop-1440__sort-header-hovered-identical.png` (gitignored; re-capture via reproduce steps if absent)
Probe: `_harness/audit10-p6hover.js`
...
## A10-043 · [D] Batched public-site character and terminology drift: apostrophes, British spelling, term casing

**URL** `/contact` · **viewport** desktop-1440 · **confidence** CONFIRMED · **pass** pass-4 · **date** 2026-08-10
...
**Evidence.** Every instance below verified in the rendered page at 1440x900 twice. Site-owned strings only; owner data in data/*.json was excluded from the vocabulary triage (the site-emitted vocabulary is 760 of 3,391 unique prose tokens, all read in full — no genuine misspelling in site-owned copy). The whole 68-page dump contains exactly ONE curly apostrophe (U+2019) against 373 entries carrying a straight one, and exactly 3 three-dot ellipses against 178 U+2026 characters. Zero mojibake sequences, zero U+FFFD, zero repeated words ("the the") across 25,750 entries.
Screenshot: `_harness/out/audit10/issues/A10-043__desktop-1440__contact-enquiry.png` (gitignored; re-capture via reproduce steps if absent)
Probe: `_harness/audit10-copyscan.js (sections a,d,e) + _harness/audit10-words.js + _harness/audit10-terms.js`

**Reproduce.**
1. Open http://127.0.0.1:8123/contact at 1440x900 and read the privacy line under the form ("…answer this enquiry") against the "General inquiries & questions" tab label above it
2. Open /no-such-page and copy the sentence "That address doesn’t exist on this site." — the apostrophe is U+2019
3. Open /products?productId=NOPE-XYZ-123 and copy "We couldn't find part" — the apostrophe is U+0027
4. Open /datasheets and /products?productId=IP29CG and /dashboard and count the renderings of the data-sheet term on each
5. Open / and compare the hero stat "25M+ / Feet in Stock" with the closing band "25 million / feet in stock. Ships today."
6. node _harness/audit10-copyscan.js d  reprints the whole dash/quote inventory the instances were drawn from
...
## A10-044 · [D] Batched admin copy nits not covered by A10-036: tab title, ellipsis style, a JSON-only error path

**URL** `/admin/` · **viewport** desktop-1440 · **confidence** CONFIRMED · **pass** pass-4 · **date** 2026-08-10

**What it does to a real person.** Nothing Rick would call a problem. Written down so the remediation plan has the exact strings and does not rediscover them.

**Evidence.** Each string read in the rendered admin page at 1440x900, twice. The signed-out screen's <title> is "IPC Admin — Login" while its own <h1> and its submit button both read "Sign In" / "Sign In →" — the browser tab names the page differently from the page. On /admin/add.php the <label> "Rows JSON" exists in the DOM but is display:none with a 0x0 box (spectable-editor.js replaces the raw textarea with the grid editor), and /admin/edit.php?id=CC renders no JSON label at all — so Rick never SEES the word, which is why this is a D and not a comprehensibility finding: the wording only surfaces on the JavaScript-off fallback path, where admin/add.php:41 and :52 and admin/edit.php:109 and :124 produce "Specifications Table JSON is invalid (" . json_last_error_msg() . "). Fix the syntax or clear the field." /admin/help.php already documents that message ("The Specifications or Size Chart won't save — it mentions invalid data/JSON."), so it is discoverable.
Probe: `_harness/audit10-copyverify.js (V9, V10) + _harness/audit10-copyscan.js (d)`

**Reproduce.**
1. Open http://127.0.0.1:8123/admin/ signed out at 1440x900 — the browser tab reads "IPC Admin — Login", the page heading and the submit button read "Sign In"
2. Sign in, open /admin/add.php, and read the description placeholder: "One paragraph per line..." (three periods)
3. In DevTools on /admin/add.php run: [...document.querySelectorAll("label")].filter(l=>/JSON/.test(l.textContent)).map(l=>getComputedStyle(l).display)  -> ["none"]
4. Open /admin/index.php and /admin/edit.php?id=CC and compare document.title — both "IPC Admin — Products"
...
**Dedupe.** A10-036 covers button-label casing, catalog/catalogue, British spellings and quote drift on content.php and help.php; none of the four instances here appears in it. A10-033 counts help-page nav/button mismatches, not page titles.

## A10-052 · [D] Batched: admin text that misses AA by 0.1-0.35, on surfaces A10-030 does not name

**URL** `/admin/index.php` · **viewport** all · **confidence** CONFIRMED · **pass** pass-5 · **date** 2026-08-10

**What it does to a real person.** Nobody perceives a 0.2 shortfall against a threshold, but these are the same red and grey inks as the errors A10-030 already records, re-used on button fills and page sub-lines where nothing has measured them.

**Evidence.** From the same 7,010-element scan (backdrop.js): 5 distinct combinations sitting between 4.16:1 and 4.39:1 against a 4.5:1 floor, plus one exactly at threshold. Confirmed by two identical runs.
Screenshot: `_harness/out/audit10/issues/A10-052__desktop-1440__admin-delete-button-4.28to1.png` (gitignored; re-capture via reproduce steps if absent)
Probe: `_harness/audit10-admincontrast.js`

**Reproduce.**
1. Sign in and open /admin/index.php
2. node _harness/audit10-admincontrast.js — the 34-row table lists each with its ratio and element count
...
**Dedupe.** A10-030 records the #dc2626-on-#fef2f2 4.41:1 .error-list treatment and names settings.php, content.php and upload-image.php. The 4.41:1 rows this scan also found on index.php, edit.php, inquiries.php and help.php are that same treatment and are deliberately NOT re-reported. Everything listed here is a different surface (#fceeee/#f8ebec button fills, #f0f4f8 page-header sub-lines, #f8eee6 and #e8f6ed help eyebrows) or a different ink.

## A10-053 · [D] Batched design-token nits: off-scale type sizes, a 1px radius split, and two monospace stacks for one role

**URL** `/datasheets` · **viewport** all · **confidence** CONFIRMED · **pass** pass-5 · **date** 2026-08-10

**What it does to a real person.** None of these is visible to a visitor. They are recorded so the type and radius scales can be read as scales — every one is a value used two or three times where a neighbouring value is used hundreds.

**Evidence.** From the 132-page computed-style census: 24 distinct fontSize values, 50 fontSize x fontWeight pairs, 17 borderRadius values, 24 letterSpacing values, 7 fontFamily values. The items below are the values used by 2 elements or fewer, the non-integer sizes, and the same-role stack splits.
Probe: `_harness/audit10-tokens.js`

**Reproduce.**
1. node _harness/audit10-stylecensus.js then node _harness/audit10-tokens.js
2. The digest prints the off-scale sizes, the fontFamily table, the radius drift and the line-height outliers
